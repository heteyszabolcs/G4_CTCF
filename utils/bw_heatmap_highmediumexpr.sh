...
computeMatrix scale-regions -o ../results/deeptools/matrix_expr_highmedium.mat.gz \
 ...
 -R ../results/rna_seq_deseq2/NT_highmedium.bed \
...
plotHeatmap -m ../results/deeptools/matrix_expr_highmedium.mat.gz \
 -out "../results/deeptools/highmediumexpr_scaleregion.pdf" \
 --heatmapHeight 14 \
 --colorMap "magma" \
 --yMin 0 \
 --yMax 10 \
