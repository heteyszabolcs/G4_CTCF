...
computeMatrix reference-point -o ../results/deeptools/matrix_ctcf.mat.gz \
...
plotHeatmap -m ../results/deeptools/matrix_ctcf.mat.gz \
 -out "../results/deeptools/CTCF_G4_both_treatments.pdf" \
 --refPointLabel "CTCF" \
 --heatmapHeight 14 \
 --colorMap "YlOrRd" \
 --yMin 0 \
...
plotHeatmap -m ../results/deeptools/matrix_ctcf.mat.gz \
 -out "../results/deeptools/CTCF_G4_both_treatments.png" \
 --refPointLabel "CTCF" \
 --heatmapHeight 14 \
 --colorMap "YlOrRd" \
 --yMin 0 \
