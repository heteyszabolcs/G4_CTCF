...
computeMatrix scale-regions -o ../results/deeptools/matrix_expr_high.mat.gz \
 ...
 -R ../results/rna_seq_deseq2/NT_high.bed \
...
plotHeatmap -m ../results/deeptools/matrix_expr_high.mat.gz \
 -out "../results/deeptools/highexpr_scaleregion.pdf" \
 --heatmapHeight 14 \
 --colorMap "magma" \
 --yMin 0 \
 --yMax 10 \
 ...
 --xAxisLabel "" \
 -z "high expr. genes" \
 --outFileSortedRegions ../results/deeptools/matrix_expr_high_sorted_regions.tsv \
 #--kmeans 2 \

plotHeatmap -m ../results/deeptools/matrix_expr_high.mat.gz \
 -out "../results/deeptools/highexpr_scaleregion.png" \
 --heatmapHeight 14 \
 --colorMap "magma" \
 --yMin 0 \
 --yMax 10 \
